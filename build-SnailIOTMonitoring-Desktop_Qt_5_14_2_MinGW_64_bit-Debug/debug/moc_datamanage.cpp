...
#include <memory>
#include "../../SnailIOTMonitoring/src/database/datamanage.h"
...
QT_MOC_LITERAL(1, 11, 13), // "databaseError"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5) // "error"

    },
    "DataManage\0databaseError\0\0error"
};
...
void DataManage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DataManage::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManage::databaseError)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DataManage::databaseError(const QString & _t1)
{
