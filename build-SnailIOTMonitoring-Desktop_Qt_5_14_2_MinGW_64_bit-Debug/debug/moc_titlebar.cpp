...
#include <memory>
#include "../../SnailIOTMonitoring/src/ui/titlebar.h"
...
QT_MOC_LITERAL(1, 9, 9), // "signalMin"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11), // "signalIsMax"
QT_MOC_LITERAL(4, 32, 11) // "signalClose"

    },
    "TitleBar\0signalMin\0\0signalIsMax\0"
    "signalClose"
};
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TitleBar::signalIsMax)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TitleBar::signalMin()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TitleBar::signalIsMax()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TitleBar::signalClose()
{
