...
#include <memory>
#include "../../SnailIOTMonitoring/src/ui/registerwindow.h"
...
QT_MOC_LITERAL(1, 15, 7), // "display"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 11), // "sendMessage"
QT_MOC_LITERAL(4, 36, 23) // "registerReturnLoginPage"

    },
    "RegisterWindow\0display\0\0sendMessage\0"
    "registerReturnLoginPage"
};
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->registerReturnLoginPage(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RegisterWindow::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterWindow::display)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RegisterWindow::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterWindow::sendMessage)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWindow::display(int _t1)
{
...
// SIGNAL 1
void RegisterWindow::sendMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
