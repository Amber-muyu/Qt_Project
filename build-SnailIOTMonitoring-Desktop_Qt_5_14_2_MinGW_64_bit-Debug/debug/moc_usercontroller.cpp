...
#include <memory>
#include "../../SnailIOTMonitoring/src/controller/usercontroller.h"
...
QT_MOC_LITERAL(1, 15, 18), // "sendModifyUserInfo"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 16), // "getLoginUserInfo"
QT_MOC_LITERAL(4, 52, 14), // "userInfoModify"
QT_MOC_LITERAL(5, 67, 18) // "userPassWordModify"

    },
    "UserController\0sendModifyUserInfo\0\0"
    "getLoginUserInfo\0userInfoModify\0"
    "userPassWordModify"
};
...
void UserController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendModifyUserInfo((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->getLoginUserInfo((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->userInfoModify(); break;
        case 3: _t->userPassWordModify(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserController::sendModifyUserInfo)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UserController::sendModifyUserInfo(const QString & _t1)
{
